...
TC_API_EXPORT Races EnumUtils<Races>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 10: return RACE_PANDAREN_ALLIANCE;
        case 11: return RACE_PANDAREN_HORDE;
...
TC_API_EXPORT size_t EnumUtils<Races>::ToIndex(Races value)
{
    switch (value)
    {
        ...
        case RACE_PANDAREN_ALLIANCE: return 10;
        case RACE_PANDAREN_HORDE: return 11;
        default: throw std::out_of_range("value");
    }
}
...
template <>
TC_API_EXPORT size_t EnumUtils<Classes>::Count() { return 11; }
...
TC_API_EXPORT SpellFamilyNames EnumUtils<SpellFamilyNames>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 15: return SPELLFAMILY_MONK;
        default: throw std::out_of_range("index");
    }
}
...
TC_API_EXPORT size_t EnumUtils<SpellFamilyNames>::ToIndex(SpellFamilyNames value)
{
    switch (value)
    {
        ...
        case SPELLFAMILY_MONK: return 15;
        default: throw std::out_of_range("value");
    }
}
}

...
public:
    ...
    struct npc_announcer_toc5AI : public CreatureAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            case INSTANCE_PROGRESS_INITIAL:
                ...
                else
                {
                    ...
                    if (player->HasAchieved(TRIAL_OF_THE_CHAMPION_A) || player->HasAchieved(TRIAL_OF_THE_CHAMPION_H))
        ...
        bool OnGossipSelect(Player* player, uint32 /*uiSender*/, uint32 uiAction) override
        {
            ...
            if (uiAction == 0 || uiAction == 1)
            {
                pInstance->SetData(DATA_ANNOUNCER_GOSSIP_SELECT, uiAction);

...
enum eNpcs
{
    ...
    // Alliance Grand Champions Mount
    JACOB_MOUNT     = 35637,
    AMBROSE_MOUNT   = 35633,
    COLOSOS_MOUNT   = 35768,
    JAELYNE_MOUNT   = 34658,
    ...
    NPC_TIRION = 34996, // Possibly wrong npc here, 34996 had already populated creature_text (from ToC25) that matches. Needs a sniff to confirm.
...
enum eTexts
{
    ...
    TEXT_WELCOME_2 = 51,
    TEXT_BEGIN = 52,
    TEXT_GRATZ_SLAIN_CHAMPIONS = 53,
    TEXT_YOU_MAY_BEGIN = 54,
...
enum eAchievements
{
    TRIAL_OF_THE_CHAMPION_A = 4296,
    TRIAL_OF_THE_CHAMPION_H = 3778,
};

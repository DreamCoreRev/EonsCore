...
enum PlayerSpecializationIconicSpellIds
{
    ...
    /* Monk - Brewmaster */
    SPELL_BREWMASTER = 25028,

    /* Monk - Mistweaver */
    SPELL_MISTWEAVER = 25031,

    /* Monk - Windwalking */
    SPELL_WINDWALKING = 25035,
...
static const uint32 PlayerSpecializationIconicSpells[MAX_CLASSES][MAX_TALENT_TREES][MaximumSpecializationIconicSpells] = {
    ...
    { // CLASS_MONK
        {SPELL_BREWMASTER}, // Brewmaster
        {SPELL_MISTWEAVER}, // Mistweaver
        {SPELL_WINDWALKING} // Windwalking
    },
    { // CLASS_DRUID

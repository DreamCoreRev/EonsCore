...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS]=
{
    ...
    &AuraEffect::HandleModStatBonusArmorPercent,                  //317 SPELL_AURA_MOD_BONUS_ARMOR_PCT
    &AuraEffect::HandleAuraModMinimumSpeedRate,                   //318 SPELL_AURA_MOD_MINIMUM_SPEED_RATE
    ...
    &AuraEffect::HandleNULL,                                      //404 SPELL_AURA_OVERRIDE_AP_BY_SPELL_POWER_PCT (used in spell 115070) (5.4.2) HandleOverrideAttackPowerBySpellPower
    ...
    &AuraEffect::HandleNULL,                                      //430 SPELL_AURA_PLAY_SCENE HandlePlayScene
...
void AuraEffect::HandleAuraModShapeshift(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    switch (form)
    {
        ...
        case FORM_TIGER:                                    // 0x24
        case FORM_OX:                                       // 0x25
        case FORM_SERPENT:                                  // 0x26
            break;
        default:

...
{
    BG_BFG_OP_OCCUPIED_BASES_HORDE      = 6201,
    BG_BFG_OP_OCCUPIED_BASES_ALLY       = 6200,
    BG_BFG_OP_RESOURCES_ALLY            = 6202,
    BG_BFG_OP_RESOURCES_HORDE           = 6203,
    BG_BFG_OP_RESOURCES_MAX             = 6204,
    BG_BFG_OP_RESOURCES_WARNING         = 1955,

    BG_BFG_OP_LIGHTHOUSE_ICON           = 1842,
    BG_BFG_OP_LIGHTHOUSE_STATE_ALLIANCE = 1767,
    BG_BFG_OP_LIGHTHOUSE_STATE_HORDE    = 1768,
    BG_BFG_OP_LIGHTHOUSE_STATE_CON_ALI  = 1769,
    BG_BFG_OP_LIGHTHOUSE_STATE_CON_HOR  = 1770,

    BG_BFG_OP_WATERWORKS_ICON           = 1846,
    BG_BFG_OP_WATERWORKS_STATE_ALLIANCE = 1782,
    BG_BFG_OP_WATERWORKS_STATE_HORDE    = 1783,
    BG_BFG_OP_WATERWORKS_STATE_CON_ALI  = 1784,
    BG_BFG_OP_WATERWORKS_STATE_CON_HOR  = 1785,

    BG_BFG_OP_MINE_ICON                 = 1845,
    BG_BFG_OP_MINE_STATE_ALLIANCE       = 1772,
    BG_BFG_OP_MINE_STATE_HORDE          = 1773,
    BG_BFG_OP_MINE_STATE_CON_ALI        = 1774,
    BG_BFG_OP_MINE_STATE_CON_HOR        = 1775
};
...
{
    BG_BFG_TEXT_START_TWO_MINUTES = 81185,
    BG_BFG_TEXT_START_ONE_MINUTE = 81186,
    BG_BFG_TEXT_START_HALF_MINUTE = 81187,

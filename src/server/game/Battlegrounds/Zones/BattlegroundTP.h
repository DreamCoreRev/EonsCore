...
{
    LANG_BG_TP_START_TWO_MINUTES        = 411860,
...
enum BG_TP_SpellId
{
    BG_TP_SPELL_HORDE_FLAG              = 88333,
    BG_TP_SPELL_HORDE_FLAG_DROPPED      = 88334,
    BG_TP_SPELL_HORDE_FLAG_PICKED       = 61266, // fake spell, does not exist but used as timer start event
    BG_TP_SPELL_ALLIANCE_FLAG           = 88335,
    BG_TP_SPELL_ALLIANCE_FLAG_DROPPED   = 88336,
...
enum BG_TP_ObjectEntry
{
    ...
    BG_OBJECT_A_FLAG_TP_ENTRY           = 209830,
    BG_OBJECT_H_FLAG_TP_ENTRY           = 209831,
